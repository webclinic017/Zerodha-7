                    ...
                    // alert(order_id);
                     ...
                     if(trigger_name!=""){
                        ...
                        if(typeof order_price === 'undefined') {
                            order_price = 0;
                            alert('Variable "order_price" is undefined.');
                        }
                        if(typeof order_trigger_price === 'undefined') {
                            order_trigger_price = 0;
                            alert('Variable "order_trigger_price" is undefined.');
                        }

                             $.ajax({

                                 url:"http://127.0.0.1:8000/groups_order_listing/group_open_trigger_order_list/update_group_order/"+order_id,
                                 method:"POST",
                                 data:JSON.stringify({
                                 "trigger": {
