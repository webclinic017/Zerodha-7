$(document).ready(function(){
    ...
    {
        var symbol =$("#p1plusp2symbol_two").val();
         ...
         success:function(result){          
               ...
               if(result.status=="success"){
                  $.each(result.content, function (index,data) {   
                       $('#p1plusp2resultsymboltwo').append('<li class="list-group-item link-class"> '+data[0].tradingsymbol+' | <span class="text-muted">'+data[0].exchange+'</span>  | <span class="text-muted">'+data[0].name+'</span></li>');   
